...
<head>
    ...
    <script type="text/javascript">
        ...
        $j(document).ready(function(){
            $j("#hosSubmit").on('click',function(){
                var codeIdArr = [];
                $j("input[name=hos]:checked").each(function(){
                    codeIdArr.push($j(this).val());
                });
            });//end function
            ...
            $j("#checkall").click(function(){
                if($j("#checkall").is(":checked")){
                    $j(".hos").prop("checked", true);
                }else{
                    $j(".hos").prop("checked", false);
                }
            });//end function

            //한개 해제하면 전체도 해제
            $j(".hos").click(function(){
                if($("input[name='hos']:checked").length == 4){
...
<%--<%
    for (MovieDTO rDTO : rList) {
        ...
        out.println("영화 평점 : " + CmmUtil.nvl(rDTO.getMovie_nm()));
        out.println("영화 순위 : " + CmmUtil.nvl(rDTO.getScore()));
        out.println("영화 순위 : " + CmmUtil.nvl(rDTO.getOpen_day()));
        out.println("<hr/>");
    }
%>--%>


<form name="document" method="get" action="testEmer2" onsubmit="return searchEmer(this);">
        ...
        <div class="row" style="text-align: center">
            <div class="col-xs-11">
                ...
                <div class="btn-group btn-group-vertical" data-toggle="buttons">
                    <label class="btn">
                        <input type="checkbox" name='hos' id="normal">
                    ...
                    <label class="btn">
                        <input type="checkbox" name='hos' id="little">
                        <i class="fa fa-square-o fa-2x"></i>
                        <i class="fa fa-check-square-o fa-2x"></i>
                        <span> 응급실 소아 병상 </span>
                    </label>
                    ...
                    <label class="btn">
                        <input type="checkbox" name='hos' id="3">
                        <i class="fa fa-square-o fa-2x"></i>
                        <i class="fa fa-check-square-o fa-2x"></i>
                    ...
                    <label class="btn">
                        <input type="checkbox" name='hos' id="4">
                        <i class="fa fa-square-o fa-2x"></i>
                        <i class="fa fa-check-square-o fa-2x"></i>
                    ...
                    <label class="btn">
                        <input type="checkbox" name='hos' id="5">
                        <i class="fa fa-square-o fa-2x"></i>
                        <i class="fa fa-check-square-o fa-2x"></i>
                        <span> 응급전용 중환자실</span>
                    </label>
                    ...
                    <div><label><input type="text" id="hospital_name" placeholder="병원명을 입력하세요."> </label>
                        ...
                        <label><input type="submit" id="hosSubmit" style="WIDTH: 80pt; HEIGHT: 20pt" value="검색"> </label>
                    </div>
