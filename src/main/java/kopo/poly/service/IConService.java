...
/*    ConDTO getCon(ConDTO cDTO) throws Exception;*/
    ...
    List<ConDTO> getSearchCon(List<String> general, String cityParam, String districtParam, String HptorClnParam, String CODE_MSTParam, String dayParam, String hosnameParam, String nameParam) throws Exception; //병의원별 목록정보 조회
}
